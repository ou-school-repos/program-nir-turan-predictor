...
the spherically symmetric family $T(x,y,z)$ cannot cross over at source-tree
size $n=5$, verify the source-tree-size-$n=6$ residue in a
verified-plus-conjecture sense, and identify crossover threshold $n=7$ as the
...
$n = 17{,}340$, refuting the previously suggested bipartite parity
...
\begin{compresult}
  ...
  graph of partition $(3, m_2)$ in this bounded sweep, achieving a crossover
  against $E_n^{(2)}$ at $n = 17$ in the completed depth-2 sweep through
  path length $n \le 51$
...
this partition family in the tested range} $n \le 51$.
...
\begin{remark}[Rigorous Resolution of Other Bipartite Families]
  ...
  smaller bipartite Leontovich example for general $E_n^{(d)}$. Here
  ``tested'' means the completed depth-2 sweep through path length
  $n \le 51$.
\end{remark}
