...
\begin{abstract}
We study the minimisation of graph homomorphisms from trees to fixed target
graphs $H$, with emphasis on Leontovich graphs and path-minimiser failures.
...
of 608,930,559 connected bipartite graphs on $m \le 15$ vertices (validated against OEIS
...
vertices, together with the 5.6~million source trees on $n \le 22$
...
both at 50 digits. These estimates give $\rho_{\mathrm{hi}} \ge
...
margin, so the computed upper bound $\rho_{\mathrm{hi}}$ stays below $1$. This is
