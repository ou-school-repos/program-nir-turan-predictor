...
crossover threshold witnessed here. For 2- or 3-orbit symmetric trees,
odd near-path crossover detection reduces to a finite base-case sign check;
for the 4-orbit tree $T(7,1,9)$, we prove that the threshold $n=13$ is permanent.
...
including a 15-vertex general-depth example, an 18-vertex classical
depth-2 example, and a 3,644-vertex example.
\end{abstract}
...
leading-coefficient sense. It is a residual-based certificate in that
sense, not a directed-rounding interval-arithmetic certificate.
