...
sweep, the 18-vertex graph $H_{18}$ from SMT synthesis followed by a completed
depth-2 bounded sweep through path length $n \le 51$, and the 3,644-vertex
double-cover witness has
