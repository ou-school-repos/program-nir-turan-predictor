...
This result is likely known in some form, but we were unable to find it stated
explicitly in the literature, so we record it here.
...
maintained at \url{https://github.com/ou-school-repos/program-nir-turan-predictor}.
