...
$|V| < 76$. This is search evidence only: it does not certify a minimum
within the star-of-stars basin or the uniqueness of the observed descent
$78 \to 77 \to 76$.

\begin{figure}[H]
\centering
\includegraphics[width=0.75\textwidth]{leontovich_76.pdf}
...
Within the explored star-of-stars basin, asymmetric pruning breaks orbital
symmetry and lifts new active eigenvalues into the quotient spectrum. The
observed crossover appears when the resulting active secondary eigenvalue is
close enough to the spectral radius to interfere with the Perron term. The
76-vertex graph is the smallest witness found by the search, not a certified
minimum; Section~\ref{sec:local-pruning-audit} describes the incomplete local
audit.
