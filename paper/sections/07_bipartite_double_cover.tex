...
the walk sequences reveals that the first even-$n$ crossover occurs at
$n=17{,}340$ and remains open through the verified even range. The same target
...
non-bipartite construction below: applying the same sibling-leaf perturbation
to its 3,644-vertex double cover gives ratios above one at both depths 2 and 4.
