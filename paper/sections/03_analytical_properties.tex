...
Exhaustive grid search over the subfamily $T(x,1,z)$ with $x,z \ge 2$ and
$|V| = 1 + 2x + xz \le 100$ confirms that $T(7,1,9)$ with 78
vertices is the smallest Leontovich graph found in that audited subfamily
within the tested range. The boundary cases $x=1$ or $z=1$ produce star
or caterpillar graphs that are not Leontovich (Proposition~\ref{prop:p3}).
This does not compare it against the full
$T(x,y,z)$ family with $y>1$. A generalized search over all
