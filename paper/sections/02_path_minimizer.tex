...
Lemma~\ref{lem:active_recurrence}, the walk-visible spectrum from
$\mathbf{1}$ is $\{\sqrt{3}, 0, -\sqrt{3}\}$, while the full spectrum also
includes the antisymmetric pair $\pm1$. The walk counts satisfy
...
that separates the $P_5$ tie classes among non-minimizers from the verified unique
