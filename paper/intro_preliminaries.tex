...
\begin{enumerate}[label=(\roman*)]
  ...
  \item \textbf{(P)} The crossover threshold of $T(7,1,9)$ is exactly
    ...
    impossibility at $n = 5$ for all targets is a polynomial identity
    (Proposition~\ref{prop:n5}). The threshold phenomenon for this
    specific graph was known in correspondence; the contribution here is
    the first fully written proof, placing it within the broader
    threshold landscape.
