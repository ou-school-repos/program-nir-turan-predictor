...
\begin{enumerate}[label=(\roman*)]
  ...
  \item \textbf{(P)} The crossover threshold of $T(7,1,9)$ is exactly
    ...
    polynomial identity (Proposition~\ref{prop:n5}). The threshold
    phenomenon for $T(7,1,9)$ had already been discussed in
    correspondence; the theorem here gives a complete written proof and
    places it in the broader threshold landscape.
