...
| $N$ | $a(N)$ (Δ≤3) | $a(N)$ (Δ≤4) | Star $2^{N-1}+1$ | Path (Fibonacci) |
| --- | ------------ | ------------ | ---------------- | ---------------- |
| 3   | 5            | 5            | 5                | 5                |
| 4   | 9            | 9            | 9                | 8                |
| 5   | 14           | 17           | 17               | 13               |
...
| 23  | 139,593      | —            | 4,194,305        | 75,025           |
| 24  | 231,117      | 432,234      | 8,388,609        | 121,393          |

**Raw sequence (N=3..24):**

```
5, 9, 14, 24, 41, 66, 110, 189, 305, 510, 863, 1425, 2345, 3987, 6515, 10905, 18254, 30135, 49913, 84546, 139593, 231117
```
