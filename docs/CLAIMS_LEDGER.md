...
[paper/intro_preliminaries.tex](/home/shane/Documents/school/ou-papers/program-nir-turan-predictor/paper/intro_preliminaries.tex:96):
...
| `n6-residue`              | The `n=6` residue is verified-plus-conjecture, not a theorem                    | `E` + conjecture | Trees on 6 vertices                                            | See manuscript wording                                                                 | `make verify/core`                      |
| `t719-threshold`          | `T(7,1,9)` has permanent depth-2 threshold `n=13`                               | `P` + `E`        | Named 4-orbit tree                                             | `Δ_11=-7434`, `Δ_13=48258`                                                             | `make verify/core`                      |
...
| `h18-margin`              | `H18` has depth-2 crossover at `n=17`                                           | `E`              | Named graph only                                               | `Hom(P_17,H18)=14,801,051,732`, `Hom(E_17^(2),H18)=14,795,982,954`, margin `5,068,778` | `python3 scripts/verify_core_claims.py` |
...
| `small-simple-sweep`      | No connected simple graph on `m<=11` produced a near-path hit                   | `S`              | `n<=200`, `d<=20`; all connected simple graphs on `m<=11`      | `1,018,680,329` tested, zero hits                                                      | See `paper.tex` sweep table             |
